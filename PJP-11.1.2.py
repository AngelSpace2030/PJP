...
# -*- coding: utf-8 -*-
"""
Unified PAQJP+PJP – Simplified (Lossless, 256 transforms always)
==============================================================
- 256 base transforms (single, no pairs) – ALWAYS used.
...
- Main menu: 3 options (Compress, Decompress, Exit).
"""
...
PROGNAME = "UnifiedPAQJP+PJP (256 Transforms)"
...
class UnifiedCompressor:
    ...
    # ------------------------------------------------------------------
    # PAQJP special transforms (33‑40)
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # Compression method (all 256 transforms always)
    # ------------------------------------------------------------------
...
# ------------------------------------------------------------
# Main menu with only 3 options
# ------------------------------------------------------------
def main():
    print(f"{PROGNAME} – Unified compression with 256 transforms")
